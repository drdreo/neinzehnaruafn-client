...
export const getPlayerState = createFeatureSelector<PlayerPartialState, PlayerState>(
  PLAYER_FEATURE_KEY
);
...
export const getAllPlayer = createSelector(getPlayerState, (state: PlayerState) =>
  selectAll(state)
);
